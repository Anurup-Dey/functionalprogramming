...
public class FP03BehaviorParameterization {
	...
	private static List<Integer> mapAndCreateNewList(List<Integer> numbers, Function<Integer, Integer> mappeingFunction) {
		return numbers.stream().map(mappeingFunction).collect(Collectors.toList());
	}
